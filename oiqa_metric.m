...
if (nargin == 6)
    ...
    scanpath_longitude = scanpath(1,1:s1:end);
    scanpath_latitude = scanpath(2,1:s1:end);
    for frame_index = 1 : frame_num
        ref_viewport = viewports_sampling(im_ref,scanpath_longitude,...
            scanpath_latitude,FOV);
        dis_viewport = viewports_sampling(im_dis,scanpath_longitude,...
            scanpath_latitude,FOV);
